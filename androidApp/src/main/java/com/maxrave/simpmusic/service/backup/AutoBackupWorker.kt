...
class AutoBackupWorker(
    ...
    override suspend fun doWork(): Result = withContext(Dispatchers.IO) {
        try {
            ...
            // Save to Downloads/SayaBeats folder
        ...
        return try {
            val contentValues = ContentValues().apply {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    put(MediaStore.Downloads.RELATIVE_PATH, "Download/SayaBeats")
                }
            }
            ...
            uri?.let { outputUri ->
                ...
                Logger.i(TAG, "Backup saved to Downloads/SayaBeats/$fileName")
                true
            } ?: false
        } catch (e: Exception) {
    ...
    private fun cleanupOldBackups(maxFiles: Int) {
        try {
            ...
            val selectionArgs = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                arrayOf("Download/SayaBeats/", "sayabeats_backup_%.zip")
            } else {
