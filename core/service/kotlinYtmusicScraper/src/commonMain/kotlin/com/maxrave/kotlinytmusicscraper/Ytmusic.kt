...
//                    },
    ...
    suspend fun checkForGithubReleaseUpdate() =
        httpClient.get("https://api.github.com/repos/shnwazdeveloper/Saya-Beats/releases/latest") {
            contentType(ContentType.Application.Json)
        }

    suspend fun checkForFdroidUpdate() =
        httpClient.get("https://f-droid.org/api/v1/packages/com.shnwazdeveloper.sayabeats") {
            contentType(ContentType.Application.Json)
        }
