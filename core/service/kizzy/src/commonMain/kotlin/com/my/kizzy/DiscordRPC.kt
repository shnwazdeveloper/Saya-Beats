...
class DiscordRPC(
    ...
    suspend fun updateSong(
        ...
        setActivity(
            ...
            buttons =
                listOf(
                    "Listen on Saya Beats" to "https://shnwazdeveloper.github.io/app/watch?v=${song.videoId}",
                    "Visit Saya Beats" to "https://github.com/shnwazdeveloper/Saya-Beats",
                ),
            type = Type.LISTENING,
            since = currentTime,
    ...
    companion object {
        ...
        private const val APP_NAME: String = "Saya Beats"
